...
import React, { Dispatch, InputHTMLAttributes, ReactHTMLElement, SetStateAction, useState } from 'react'
...
function SignUpModal(props: Props) {
  const { show, setShow, singInfo, setSignInfo, setShowTwo } = props
        ...
        <Modal.Body>
          ...
          <div>
            <input
              ...
              // disabled={validator(['firstName', 'lastName', 'email'])}
              onClick={handleNext}
            />
          </div>
