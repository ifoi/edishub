            ...
            <div className="modal-body">
              ...
              <div className="separator mt-3">
                <svg width="420" height="15" viewBox="0 0 500 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <line y1="5.5" x2="227" y2="5.5" stroke="black" stroke-opacity="0.1" />
                  <line x1="272" y1="5.5" x2="500" y2="5.5" stroke="black" stroke-opacity="0.1" />
                </svg>
              </div>
              ...
              <div>
                <input type="button" value="Continue" className='form-control mt-4' style={{ background: '#385FB9', color: '#FFF' }} />
              </div>
